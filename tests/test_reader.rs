...
fn test_record_from_record_string_rejects_payload_length_mismatches() {
  assert_eq!(Record::from_record_string(":0C0010006164647265737320676170A6"), Err(ReaderError::PayloadLengthMismatch));
  assert_eq!(Record::from_record_string(":000010006164647265737320676170B2"), Err(ReaderError::PayloadLengthMismatch));
  assert_eq!(Record::from_record_string(":01000001FE"), Err(ReaderError::PayloadLengthMismatch));
  assert_eq!(Record::from_record_string(":0F0000021200DD"), Err(ReaderError::PayloadLengthMismatch));
  assert_eq!(Record::from_record_string(":0200000300003800C3"), Err(ReaderError::PayloadLengthMismatch));
  assert_eq!(Record::from_record_string(":01000004FFFFFD"), Err(ReaderError::PayloadLengthMismatch));
  assert_eq!(Record::from_record_string(":05000005000001CD28"), Err(ReaderError::PayloadLengthMismatch));
}

#[test]
fn test_record_from_record_string_rejects_unsupported_record_types() {
  assert_eq!(Record::from_record_string(":0B0010066164647265737320676170A1"), Err(ReaderError::UnsupportedRecordType(0x06)));
  assert_eq!(Record::from_record_string(":0B0010FF6164647265737320676170A8"), Err(ReaderError::UnsupportedRecordType(0xFF)));
}

#[test]
fn test_record_from_record_string_rejects_invalid_lengths_for_types() {
  assert_eq!(Record::from_record_string(":01000001FFFF"), Err(ReaderError::InvalidLengthForType));
  assert_eq!(Record::from_record_string(":0100000200FD"), Err(ReaderError::InvalidLengthForType));
  assert_eq!(Record::from_record_string(":03000002FF1200EA"), Err(ReaderError::InvalidLengthForType));
  assert_eq!(Record::from_record_string(":03000003003800C2"), Err(ReaderError::InvalidLengthForType));
  assert_eq!(Record::from_record_string(":050000030000003800C0"), Err(ReaderError::InvalidLengthForType));
  assert_eq!(Record::from_record_string(":01000004FFFC"), Err(ReaderError::InvalidLengthForType));
  assert_eq!(Record::from_record_string(":03000004FFFFFFFC"), Err(ReaderError::InvalidLengthForType));
  assert_eq!(Record::from_record_string(":030000050000CD2B"), Err(ReaderError::InvalidLengthForType));
  assert_eq!(Record::from_record_string(":0500000500000000CD29"), Err(ReaderError::InvalidLengthForType));
}
...
fn test_record_from_record_string_parses_valid_start_segment_address() {
  assert_eq!(Record::from_record_string(":04000003123438007B"), Record::from_record_string(":04000003123438007b"));
